      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6'>
        <div className='flex flex-col gap-4 sm:gap-6'>
          <div className='space-y-3 sm:space-y-4'>
            ...
            <h2 className='text-3xl sm:text-6xl font-bold uppercase'>
              Philippe Starck
            </h2>
            <p className='text-sm text-gray-600'>
              Philippe Starck. Born in Paris in 1949. Son of a French
              aeronautical engineer and inventor. He studied interior
              architecture and design at the École Nissim de Camondo, Paris. In
              1976 he founded the company “Starck Product”. Designing the
              private rooms of François Mitterrand at the Élysée Palace made him
              famous. The Café Costes in Paris made him an international star.{' '}
              <br />
              <br />
              In 1995, he created a new category with the Delano boutique hotel
              in Miami: designer hotels. He has long been successful in
              international residential projects: Under the name Yoo, Philippe
              Starck creates outstanding apartments at unique locations all over
              the world. <br />
              <br /> In 2000 Philippe Starck received the National Order of the
              Legion of Honour. One of numerous coveted distinctions which he
              has been awarded over the course of his career, which spans more
              than 30 years. Find out more about Philippe Starck:{' '}
