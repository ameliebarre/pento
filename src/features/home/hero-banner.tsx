    ...
    <section className="relative right-1/2 left-1/2 mx-[-50vw] w-screen">
      <div className="relative min-h-140 w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-5.5 px-4 text-center text-white">
          <h1 className="font-heading max-w-3xl text-4xl md:text-[60px]">
          ...
          <Link
            href="/products"
            className="group inline-flex items-center gap-2 rounded-[6px] bg-white px-6 py-3 text-sm font-normal text-black uppercase"
          >
            Shop now
            <ArrowRight
              aria-hidden="true"
